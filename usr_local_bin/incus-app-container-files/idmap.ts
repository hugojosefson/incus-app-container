...
export const IDMAP_BASE_MIN = 1_000_000;
export const IDMAP_BASE_SIZE = 1_000_000;
 ...
 *     - minimum: 1_000_000
 *     - based on the highest uid or gid that owns an immediate subdirectory of apps, choose the next even million that is at least 1_000_000 larger than the existing.
...
/**
 * choose the next even million that is at least 1_000_000 larger than the existing
 * @param existingMaxId any existing maximum id
 * @returns the next even million that is at least 1_000_000 larger than the existing
 */
